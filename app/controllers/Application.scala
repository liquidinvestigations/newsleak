  ...
  def jsRoutes(varName: String = "jsRoutes") = Action { implicit request =>
    ...
    Ok(
      JavaScriptReverseRouter(varName)(
        ...
        controllers.routes.javascript.DocumentController.createInitEntity,
        ...
        controllers.routes.javascript.NetworkController.highlightKeysByEnt,
        controllers.routes.javascript.KeywordNetworkController.highlightEntsByKey,
        controllers.routes.javascript.KeywordNetworkController.multiSearchFilters,
        controllers.routes.javascript.KeywordNetworkController.blacklistEntitiesByIdKeyword,
        controllers.routes.javascript.KeywordNetworkController.mergeKeywords,
        controllers.routes.javascript.KeywordNetworkController.changeEntityNameByIdKeyword,
        controllers.routes.javascript.KeywordNetworkController.induceSubgraphKeyword,
        controllers.routes.javascript.KeywordNetworkController.addNodesKeyword,
        controllers.routes.javascript.KeywordNetworkController.getNeighborCountsKeyword,
        ...
        controllers.routes.javascript.EntityController.getBlacklistedKeywords,
        ...
        controllers.routes.javascript.EntityController.getBlacklistsByDoc,
        controllers.routes.javascript.NetworkController.changeEntityTypeById,
        controllers.routes.javascript.KeywordNetworkController.changeEntityTypeByIdKeyword,
